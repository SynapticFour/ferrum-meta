...
- `scripts/export-profile.sh` — GHGA/EGA/H3Africa **starter** bundle (same YAML as Ferrum `ferrum meta export --starter`). Live DRS ids: Ferrum `ferrum meta export` without `--starter`.
